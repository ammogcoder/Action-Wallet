...
public final class Constants {
    ...
    public static final String COIN_SYMBOL = "Action";
    public static final String ACCOUNT_PREFIX = "ACTN";
    public static final String PROJECT_NAME = "Action";
    ...
    public static final long MAX_BALANCE_NXT = 10000000000L;
